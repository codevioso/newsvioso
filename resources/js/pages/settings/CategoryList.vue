<template>
    <AdminLayout>
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <router-link
                            to="/secure/administrator/settings/categories/create"
            ...
            <!-- Error Message -->
            <div v-if="categoryStore.error" class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-800 dark:text-red-200">{{ categoryStore.error }}</p>
                    </div>
                </div>
            </div>

            <!-- Loading State -->
            <div v-if="categoryStore.isLoading" class="flex justify-center items-center py-12">
                <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600"></div>
            </div>

            <!-- Categories Table -->
            <div v-else-if="categoryStore.hasCategories" class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <tr v-for="category in categoryStore.categories" :key="category.id" class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium"
                                          :class="category.is_active ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200'">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        <router-link
                                            :to="`/secure/administrator/settings/categories/${category.id}/edit`"
                ...
                <!-- Pagination -->
                <div v-if="categoryStore.totalPages > 1" class="bg-white dark:bg-gray-800 px-4 py-3 border-t border-gray-200 dark:border-gray-700 sm:px-6">
                    <div class="flex items-center justify-between">
                        <div class="flex-1 flex justify-between sm:hidden">
                            <button
                                @click="goToPage(categoryStore.currentPage - 1)"
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700 dark:text-gray-300">
                                    Showing
                                    <span class="font-medium">{{ (categoryStore.currentPage - 1) * categoryStore.pagination.per_page + 1 }}</span>
                                    to
                                    <span class="font-medium">{{ Math.min(categoryStore.currentPage * categoryStore.pagination.per_page, categoryStore.totalCategories) }}</span>
                                    of
                                    <span class="font-medium">{{ categoryStore.totalCategories }}</span>
                                    results
                                </p>
                            </div>
                            <div>
...
const applyFilters = () => {
    categoryStore.setFilters(filters.value);
...
const goToPage = (page) => {
    if (page >= 1 && page <= categoryStore.totalPages) {
